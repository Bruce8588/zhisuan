#!/usr/bin/env python3
"""
使用趋势判断程序对15只检查股票进行趋势判断
使用连贯数据（2015-2024日线 + 2025-2026分钟）
"""
import os
import sys
import pandas as pd
...
OUTPUT_DIR = os.path.join(BASE_DIR, "output_check_stocks")
...
def main():
    ...
    for code, config in CORRECT_CONFIG.items():
        ...
        try:
            ...
            result = analyze_stock(code, df, config)
